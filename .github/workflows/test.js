...
const count = keyify({
    "setting": {
        "options": "Настойки",
        "plugin": "Плъгин",
        "builtin-plugins": "Основни пплъгини",
        ...
        "editor": {
            ...
            "option-strict-line-break-description": "В режим на изглед, ингорира единичните прекъсвания на реда, в зависимост от спецификациите на Markdown. Изключи тази опция, за да се показват единичните прекъсвания на реда в режим на изглед.",
            "option-show-frontmatter": "Покажи frontmatter",
            "option-show-frontmatter-description": "В режим на изглед, покажи frontmatter като кодов блок. Turn off to hide frontmatter section.",
            "option-auto-pair-brackets": "Автоматично затваряне на скоби",
            "option-auto-pair-brackets-description": "Автоматично затваряне на скоби и кавички.",
            "option-auto-pair-markdown": "Aвтоматично затваряне на тагове Markdown",
            "option-auto-pair-markdown-description": "Автоматично затваря тагове за удебелен и курсив стилове.",
            "option-smart-indent-lists": "Отстъп на списък",
            "option-smart-indent-lists-description": "Автоматично добавя отстъпи и символи за списъци.",
            "option-fold-heading": "Свиване на заглавията.",
            "option-fold-heading-description": "Позволява да се сложи всякакъв текст под заглавие.",
            "option-fold-indent": "Отстъп на свиването.",
            "option-fold-indent-description": "Свива текста с равни отстъпи, както при списъците.",
            ...
            "option-show-line-number": "Показване на номера на реда",
            "option-show-line-number-description": "Добавя номериране на редовете към полетата.",
            ...
            "option-use-tabs": "Използвай табулации.",
            "option-use-tabs-description": "Използвайте табулации за отстъпи, когато натиснете \"Tab\" клавиша. Изключете тази опция, за да използвате интервали вместо табулации.",
            "option-tab-size": "Размер на табулациите.",
            "option-tab-size-description": "Брой на интервалите, на които е равна една табулация.",
